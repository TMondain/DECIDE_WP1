...
dfm_df_no_dups <- dfm_df %>% 
  distinct(sp_n, date, lon, lat) # use these columns to determine whether or not distinct

if(write){
  
  write.csv(dfm_df, file = '../../data/edited_insect_data/moth/DayFlyingMoths_EastNorths_no_duplicates.csv')
