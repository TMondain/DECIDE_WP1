...
# "Data/BNM_NRMS/BNM_NRMS_data_2000_onwards/lepidoptera_names.csv")
...
write.csv(df_nodups, file = "../../../data/edited_insect_data/moth/moth_no_duplicates.csv")
...
dfm_df <- df_nodups[df_nodups$sp_n %in% dfm,]

dfm_df_east_north <- gr_let2num(dfm_df)

write_csv(df_nodups, file = "../../../data/edited_insect_data/moth/DayFlyingMoths_East_Norths.csv")
